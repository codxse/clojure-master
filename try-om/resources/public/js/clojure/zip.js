...
return cljs.core.assoc.call(null,node,new cljs.core.Keyword(null,"content","content",15833224),(function (){var and__27109__auto__ = children;
...
if(cljs.core.truth_(clojure.zip.branch_QMARK_.call(null,loc))){
var vec__30281 = loc;
var node = cljs.core.nth.call(null,vec__30281,(0),null);
var path = cljs.core.nth.call(null,vec__30281,(1),null);
var vec__30284 = clojure.zip.children.call(null,loc);
...
var vec__30292 = loc;
var node = cljs.core.nth.call(null,vec__30292,(0),null);
var map__30295 = cljs.core.nth.call(null,vec__30292,(1),null);
...
var path = map__30295__$1;
var l = cljs.core.get.call(null,map__30295__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.call(null,map__30295__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.call(null,map__30295__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var r = cljs.core.get.call(null,map__30295__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var changed_QMARK_ = cljs.core.get.call(null,map__30295__$1,new cljs.core.Keyword(null,"changed?","changed?",-437828330));
if(cljs.core.truth_(pnodes)){
var pnode = cljs.core.peek.call(null,pnodes);
return cljs.core.with_meta.call(null,(cljs.core.truth_(changed_QMARK_)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [clojure.zip.make_node.call(null,loc,pnode,cljs.core.concat.call(null,l,cljs.core.cons.call(null,node,r))),(function (){var and__27109__auto__ = ppath;
if(cljs.core.truth_(and__27109__auto__)){
...
var vec__30306 = loc;
var node = cljs.core.nth.call(null,vec__30306,(0),null);
var map__30309 = cljs.core.nth.call(null,vec__30306,(1),null);
...
var l = cljs.core.get.call(null,map__30309__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var vec__30310 = cljs.core.get.call(null,map__30309__$1,new cljs.core.Keyword(null,"r","r",-471384190));
...
var r = first__30312;
var rnext = seq__30311__$1;
var rs = vec__30310;
if(cljs.core.truth_((function (){var and__27109__auto__ = path;
if(cljs.core.truth_(and__27109__auto__)){
return rs;
} else {
return and__27109__auto__;
...
var vec__30319 = loc;
var node = cljs.core.nth.call(null,vec__30319,(0),null);
var map__30322 = cljs.core.nth.call(null,vec__30319,(1),null);
...
var path = map__30322__$1;
var l = cljs.core.get.call(null,map__30322__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.call(null,map__30322__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__27109__auto__ = path;
if(cljs.core.truth_(and__27109__auto__)){
return r;
} else {
...
var vec__30329 = loc;
var node = cljs.core.nth.call(null,vec__30329,(0),null);
var map__30332 = cljs.core.nth.call(null,vec__30329,(1),null);
...
var path = map__30332__$1;
var l = cljs.core.get.call(null,map__30332__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.call(null,map__30332__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__27109__auto__ = path;
if(cljs.core.truth_(and__27109__auto__)){
...
var vec__30339 = loc;
var node = cljs.core.nth.call(null,vec__30339,(0),null);
var map__30342 = cljs.core.nth.call(null,vec__30339,(1),null);
...
var path = map__30342__$1;
var l = cljs.core.get.call(null,map__30342__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.call(null,map__30342__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__27109__auto__ = path;
if(cljs.core.truth_(and__27109__auto__)){
return cljs.core.seq.call(null,l);
} else {
...
var vec__30349 = loc;
var node = cljs.core.nth.call(null,vec__30349,(0),null);
var map__30352 = cljs.core.nth.call(null,vec__30349,(1),null);
...
var path = map__30352__$1;
var l = cljs.core.get.call(null,map__30352__$1,new cljs.core.Keyword(null,"l","l",1395893423));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__30359 = loc;
var node = cljs.core.nth.call(null,vec__30359,(0),null);
var map__30362 = cljs.core.nth.call(null,vec__30359,(1),null);
...
var path = map__30362__$1;
var r = cljs.core.get.call(null,map__30362__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__30367 = loc;
var _ = cljs.core.nth.call(null,vec__30367,(0),null);
var path = cljs.core.nth.call(null,vec__30367,(1),null);
...
var len__28342__auto___30373 = arguments.length;
var i__28343__auto___30374 = (0);
while(true){
if((i__28343__auto___30374 < len__28342__auto___30373)){
args__28349__auto__.push((arguments[i__28343__auto___30374]));

var G__30375 = (i__28343__auto___30374 + (1));
i__28343__auto___30374 = G__30375;
continue;
} else {
}
break;
...
return clojure.zip.edit.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__28350__auto__);
});
...
clojure.zip.edit.cljs$lang$applyTo = (function (seq30370){
...
return clojure.zip.edit.cljs$core$IFn$_invoke$arity$variadic(G__30371,G__30372,seq30370__$2);
});
...
var or__27121__auto__ = (function (){var and__27109__auto__ = clojure.zip.branch_QMARK_.call(null,loc);
if(cljs.core.truth_(and__27109__auto__)){
...
var or__27121__auto____$1 = clojure.zip.right.call(null,loc);
...
var or__27121__auto____$2 = clojure.zip.right.call(null,clojure.zip.up.call(null,p));
if(cljs.core.truth_(or__27121__auto____$2)){
return or__27121__auto____$2;
} else {
var G__30376 = clojure.zip.up.call(null,p);
p = G__30376;
continue;
}
} else {
...
var loc__$1 = lloc;
while(true){
var temp__6751__auto____$1 = (function (){var and__27109__auto__ = clojure.zip.branch_QMARK_.call(null,loc__$1);
if(cljs.core.truth_(and__27109__auto__)){
...
var G__30377 = clojure.zip.rightmost.call(null,child);
loc__$1 = G__30377;
continue;
} else {
return loc__$1;
...
var vec__30383 = loc;
var node = cljs.core.nth.call(null,vec__30383,(0),null);
var map__30386 = cljs.core.nth.call(null,vec__30383,(1),null);
...
var path = map__30386__$1;
var l = cljs.core.get.call(null,map__30386__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.call(null,map__30386__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.call(null,map__30386__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.call(null,map__30386__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Remove at top";
} else {
...
while(true){
var temp__6751__auto__ = (function (){var and__27109__auto__ = clojure.zip.branch_QMARK_.call(null,loc__$1);
if(cljs.core.truth_(and__27109__auto__)){
return clojure.zip.down.call(null,loc__$1);
} else {
return and__27109__auto__;
...
var G__30388 = clojure.zip.rightmost.call(null,child);
loc__$1 = G__30388;
continue;
} else {
return loc__$1;
...
return cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [clojure.zip.make_node.call(null,loc,cljs.core.peek.call(null,pnodes),rs),(function (){var and__27109__auto__ = ppath;
if(cljs.core.truth_(and__27109__auto__)){
return cljs.core.assoc.call(null,ppath,new cljs.core.Keyword(null,"changed?","changed?",-437828330),true);
} else {
return and__27109__auto__;
...
//# sourceMappingURL=zip.js.map?rel=1485671331514